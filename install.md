# Spaceship Titanic guide installation
...
To move beyond notebook prototyping, all reusable code should go into the `spsp_tt/` folder package. To use that package inside your project, install the project's module in editable mode, so you can edit files in the `spsp_tt` folder and use the modules inside your notebooks :
...
```python
from spsp_tt.utils.paths import data_dir
data_dir()
```
